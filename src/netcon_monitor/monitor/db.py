...
class NetconMonDb:
    ...
    def __init__(self, config) -> None:
        self._config = config
        self.store = shelve.open(self._config['DATABASE_PATH'] + '/' + self.DATABASE_FILE)
    ...
    def dump(self):
        ...
        # print(f"### YES     AA:AA:AA:AA:AA:AA 192.168.123.124 2022/08/17 10:10:31 123456789012345678901234567890 12345678901234567890123456789012345 2022/08/17 10:10:31")
        print(f"#   Enabled MAC address       IP Address      Last seen           Hostname                       Manufacturer                        Alarm date")
        for i, elt in enumerate(self.store):
            print("{:<3} {:<7} {:<17} {:<15} {:<19} {:<30} {:<35} {:<19}".format(
                i,
