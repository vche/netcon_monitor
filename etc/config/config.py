...
REMOTE_PRIVATE_KEY_FILE = "/config/netcon_rsa"      # Use the private key in the specified file to connect
...
TELEGRAM_BOT_KEY = "1110478838:AAGZVZaDmjABTIxpCLVIDI5r9yj5h_8g"
TELEGRAM_CHAT_ID = "-479241128"
TELEGRAM_MESSAGE = "<b>{} new connections to home network</b>:\n\n{}"
...
PORT = 9334  # ports < 1024 need root
